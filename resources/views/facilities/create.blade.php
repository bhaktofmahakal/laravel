    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4><i class="fas fa-plus me-2"></i>Add New Recycling Facility</h4>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('facilities.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('last_update_date') is-invalid @enderror" 
                               id="last_update_date" name="last_update_date" value="{{ old('last_update_date', date('Y-m-d')) }}" required>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-success">
                            <i class="fas fa-save me-2"></i>Create Facility
                        </button>
                    </div>
                </form>
            </div>
